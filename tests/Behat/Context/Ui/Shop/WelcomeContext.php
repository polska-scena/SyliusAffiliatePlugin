...
namespace Tests\PolskaScena\SyliusAffiliatePlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\PolskaScena\SyliusAffiliatePlugin\Behat\Page\Shop\WelcomePageInterface;
